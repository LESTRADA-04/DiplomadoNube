<template>
    <layautPage title="Editar Habitacion">
            ...
            <div class="mb-4">
                <div class="grid grid-flow-row md:grid-flow-col gap-3">
                    <div class="sm:col-span-4 justify-center">
                        <label for="nombre" class="block mb-2 text-sm font-medium text-gray-900 ">Cantidad de
                            habitaciones</label>
                        <input type="text" id="nombre"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            v-model="room.quantity" placeholder="Cantidad de habitaciones" required>
                    ...
                    <div class="sm:col-span-4 justify-center">
                        <label for="countries" class="block mb-2 text-sm font-medium text-gray-900">Tipo de
                            habitacion</label>
                        <select id="countries" v-model="room.room_type_id"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            ...
            <div class="mb-4">
                <div class="grid grid-flow-row md:grid-flow-col gap-3">
                    <div class="sm:col-span-4 justify-center">
                        <label for="countries" class="block mb-2 text-sm font-medium text-gray-900">Tipo de
                            acomodacion</label>
                        <select id="countries" v-model="room.accommodation_id"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
...
export default {
    ...
    async created() {
        ...
        try {
            ...
            const responseHotel = await axios.get(`http://146.190.32.176/diplomado/api/hotels/${this.room.hotel.id}`);
        ...
        async submitForm() {
            ...
            try {
                ...
                const response = await axios.put(
                    `http://146.190.32.176/diplomado/api/rooms/${this.id}`,
                    this.room
                );
                ...
                if (error.response && error.response.data && error.response.data.errors) {
                    ...
                    this.errorMessages.quantity = errors.simple;
                }
            }
        },
    }
